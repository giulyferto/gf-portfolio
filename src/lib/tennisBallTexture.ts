...
// Shared between TennisBallField (the Hero's particle field) and RacketScene
// (the ball that lands in front of the horizontal racket) — same procedural
// texture, generated once per canvas rather than duplicated, so any future
// tuning (like the seam-tangent fix below) only needs to happen in one place.
